...
def build_dict(path_root, path_indir, eventfiles, path_dict):
    print(open(os.path.join(path_indir, eventfiles[0]), 'rb'))
...
if __name__ == '__main__':
    ...
    if not os.path.exists(path_dict):
        print('kaas')
        build_dict(path_root, path_indir, eventfiles, path_dict)
