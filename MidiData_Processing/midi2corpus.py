...
def proc_one(path_midi, path_outfile, emotion):
    # --- load --- #
...
if __name__ == '__main__':
    ...
    for fidx in range(n_files):
        try:
            ...
            emotionindex = namelist.index(os.path.basename(path_infile))
            emo = catlist[emotionindex]

            # proc
            _ = proc_one(path_infile, path_outfile, emo)
        except:
            print('{}/{}'.format(fidx, n_files))
            print('failed :(')
            pass